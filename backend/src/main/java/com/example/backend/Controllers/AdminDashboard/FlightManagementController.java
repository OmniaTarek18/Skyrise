...
public class FlightManagementController {
    ...
    public ResponseEntity<String> addFlight(@Valid @RequestBody FlightAddDTO flightDTO) {
        flightManagmentService.addFlight(flightDTO);
        return ResponseEntity.ok("The flight has been added successfully.");
    }
}
