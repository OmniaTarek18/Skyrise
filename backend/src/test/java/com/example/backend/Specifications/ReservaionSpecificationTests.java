...
public class ReservaionSpecificationTests {
    ...
    void testContainsUserIdSpecification() {
        ...
        Specification<Reservation> spec = ReservationSpecifications.containsUserId(1);
        List<Reservation> results = reservationRepository.findAll(spec);

        assertNotNull(results);
        assertEquals(1, results.size());
        assertEquals(1, results.get(0).getUser().getId());
    }
    ...
    void testContainsFlightIdSpecification() {
        ...
        Specification<Reservation> spec = ReservationSpecifications.containsFlightId(1);
        List<Reservation> results = reservationRepository.findAll(spec);
    ...
    void testContainsSourceSpecification() {
        ...
        Specification<Reservation> spec = ReservationSpecifications.containsSource("New York, USA");
        List<Reservation> results = reservationRepository.findAll(spec);
        ...
        String resultSourceCountry = resultDepartureAirport.getAirportCountry();

        assertNotNull(results);
        assertEquals(1, results.size());
        assertEquals("New York, USA", resultSourceCity.concat(", " + resultSourceCountry));
    }
    ...
    void testContainsDestinationSpecification() {
        ...
        Specification<Reservation> spec = ReservationSpecifications.containsDestination("Los Angeles, USA");
        List<Reservation> results = reservationRepository.findAll(spec);
        ...
        assertEquals("Los Angeles, USA", resultSourceCity.concat(", " + resultSourceCountry));
    }
    ...
    void testContainsDepartureDateSpecification() {
        ...
        Specification<Reservation> spec = ReservationSpecifications
                .containsDepartureDate(LocalDate.parse("2024-10-12"));
        List<Reservation> results = reservationRepository.findAll(spec);

        assertNotNull(results);
        assertEquals(1, results.size());
        assertEquals(LocalDate.parse("2024-10-12"), results.get(0).getFlight().getDepartureDate());
    }
    ...
    void testContainsArrivalDateSpecification() {
        ...
        Specification<Reservation> spec = ReservationSpecifications.containsArrivalDate(LocalDate.parse("2024-10-11"));
        List<Reservation> results = reservationRepository.findAll(spec);

        assertNotNull(results);
        assertEquals(1, results.size());
        assertEquals(LocalDate.parse("2024-10-11"), results.get(0).getFlight().getArrivalDate());
    }
    ...
    void testSortedByDepartureDateAscendingly() {
        ...
        Specification<Reservation> specAsc = ReservationSpecifications.sortedByDepartureDate("ASC");
    ...
    void testSortedByDepartureDateDescendingly() {
        ...
        Specification<Reservation> specDesc = ReservationSpecifications.sortedByDepartureDate("Desc");
    ...
    void testSortedByArrivalDateAscendingly() {
        ...
        Specification<Reservation> specAsc = ReservationSpecifications.sortedByArrivalDate("ASC");
    ...
    void testSortedByArrivalDateDescendingly() {
        ...
        Specification<Reservation> specDesc = ReservationSpecifications.sortedByArrivalDate("Desc");
